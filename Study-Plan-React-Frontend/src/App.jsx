...
function AppContent() {
  ...
  const SmartPlanView = () => {
    ...
    const planType = studyPlan.plan_type || 
                    ...
                    (studyPlan.new_score_oriented_data ? 'new_score_oriented' : null) ||
                    'Custom'
    ...
    switch (planType.toLowerCase()) {
      case 'new_score_oriented':
      case 'new score-oriented':
        return <NewScoreOrientedPlanView studyPlan={studyPlan} />
      
      case 'score-oriented':
      case 'generic':
        return <ScoreOrientedPlanView studyPlan={studyPlan} />
